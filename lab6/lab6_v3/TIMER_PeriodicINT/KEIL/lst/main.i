...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(((((1) & 0x03) << 30)|(((3) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((7) & 0x07) << 25)|(((12) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)), (0x0UL<<8), 0);
...
int main(void){
    ...
    TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), (1UL << 27), 2);
    TIMER_EnableInt(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)));

     
    TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)), (1UL << 27), 3);
