...
#line 13 "..\\main.c"
#line 1 "..\\..\\..\\..\\Library\\Nu-LB-NUC140\\Include\\Note_Freq.h"
...
int32_t main (void)
{
  ...
  uint32_t pitch[72] = {
    ...
    PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), (1UL));	
	  ...
	  for (i=0; i<72; i++) {
			PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, music[i], 90); 
			if (music[i]!=0) PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), (1UL));
			else             PWM_DisableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), (1UL));
