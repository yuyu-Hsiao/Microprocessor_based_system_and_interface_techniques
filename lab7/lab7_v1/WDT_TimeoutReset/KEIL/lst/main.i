...
void SYS_Init(void)
{
    ...
    CLK_EnableXtalRC(((1ul << 0) | (1ul << 3)));

     
    CLK_WaitClockReady(((1ul << 0) | (1ul << 3)));
    ...
    CLK_SetModuleClock(((((1) & 0x03) << 30)|(((0) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((3) & 0x07) << 25)|(((0) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)), (0x3UL<<0), 0);
...
int main(void)
{
    ...
    if(((((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCR & (1ul << 2))? 1 : 0) == 1)
    {
         
        GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 0, 0x1UL);
        (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((0)<<2)))) = 1;

        (((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCR = (((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCR & ~((1ul << 3) | (1ul << 5))) | (1ul << 2));
    ...
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 0, 0x1UL);
    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((0)<<2)))) = 1;
    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((0)<<2)))) = 0;
