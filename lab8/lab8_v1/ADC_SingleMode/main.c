...
#define train_data_num  				//Total number of training data
#define test_data_num 					//Total number of testing data

/******************************************************************
 * Network Configuration - customized per network 
 ******************************************************************/
#define input_length 						//The number of input
#define HiddenNodes 						//The number of neurons in hidden layer
#define target_num  						//The number of output

const float LearningRate = 						//Learning Rate
const float Momentum = 0.9;
const float InitialWeightMax = 0.5;
const float goal_acc = 								//Target accuracy

// Create training dataset/output
float train_data_input[train_data_num][input_length] = {0};	// You can put your training dataset here
int train_data_output[train_data_num][target_num] = {0}; 		// Label of the training data

// Create testing dataset/output
float test_data_input[test_data_num][input_length] = {0};		// You can put your testing dataset here
int test_data_output[test_data_num][target_num] = {0}; 			// Label of the testing data
