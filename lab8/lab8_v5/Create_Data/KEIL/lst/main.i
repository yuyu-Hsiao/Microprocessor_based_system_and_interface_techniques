...
void SYS_Init(void)
{
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP &= ~((1UL<<0) | (1UL<<1) | (1UL<<2));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP |= (1UL<<0) | (1UL<<1) | (1UL<<2);
...
void init_Light(void){
		...
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT &= ~(1 << 0); 
}
void AdcSingleCycleScanModeTest()
{
		...
		while (u32Index<30)
    {
        ...
        u32ChannelData[u32Index][0] = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(0)] & (0xFFFFul << 0));
        u32ChannelData[u32Index][1] = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(1)] & (0xFFFFul << 0));
        u32ChannelData[u32Index][2] = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(2)] & (0xFFFFul << 0));	
...
int main(void)
{
    ...
    CLK_DisableModuleClock(((((1) & 0x03) << 30)|(((28) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((3) & 0x07) << 25)|(((2) & 0x1f) << 20)| (((0) & 0x03) << 18)|(((0xFF) & 0xff) << 10)|(((16) & 0x1f) << 5)));
