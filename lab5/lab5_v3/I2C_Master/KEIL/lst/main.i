...
volatile uint8_t g_u8MstTxData;
volatile uint8_t is_Tx_send = 0;
volatile uint8_t g_u8MstEndFlag = 0;
volatile uint8_t slave_reg_addr;
...
static volatile I2C_FUNC s_I2C0HandlerFn = 0;
...
void I2C0_IRQHandler(void)
{
    ...
    if(( (((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CTOC & (1ul << 0)) == (1ul << 0) ? 1:0 ))
    {
...
void I2C_MasterRx(uint32_t u32Status)
{
    ...
    {
        ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CDAT = slave_reg_addr);
        ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON = ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & ~0x3c) | 0x08UL);
    }
    else if(u32Status == 0x20)                   
    {
        ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON = ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & ~0x3c) | 0x38UL);
    }
    else if(u32Status == 0x28)                   
    {
			((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON = ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & ~0x3c) | 0x28UL);
    }
    ...
    {
        g_u8MstRxData = (unsigned char) ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CDAT);
        ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON = ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & ~0x3c) | 0x18UL);
        g_u8MstEndFlag = 1;
    }
    else
    {
...
void I2C_MasterTx(uint32_t u32Status)
{
    ...
    else if(u32Status == 0x28)                   
    {
        if(is_Tx_send)
        {
            ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CDAT = g_u8MstTxData);
            ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON = ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & ~0x3c) | 0x08UL);
						is_Tx_send = 1;
        }
        else
...
void I2C0_Close(void)
{
    ...
    I2C_DisableInt(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
    NVIC_DisableIRQ(I2C0_IRQn);

     
    I2C_Close(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
    CLK_DisableModuleClock(((((1) & 0x03) << 30)|(((8) & 0x1f) << 0) | (((0x0) & 0x03) << 28)|(((0x0) & 0x07) << 25)|(((0x0) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));
}
