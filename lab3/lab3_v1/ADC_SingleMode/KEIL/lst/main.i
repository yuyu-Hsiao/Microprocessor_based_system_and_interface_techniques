...
void ADC_Init(){
		...
		ADC_Open(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)), (0UL<<10), (0UL<<2), 0x1 << 2);
...
void GPIO_Init(void)
{
		...
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT & 0x0FFF)|0xF000;
}
...
void AdcSingleModeTest()
{
    ...
    printf("+----------------------------------------------------------------------+\n");
		...
		while (1)
		{
        if (abs(scaledValue - previousScaledValue) > 10)
        {
            ...
            previousScaledValue = scaledValue; 
			  ...
			  if(counter==referenceValue){
						...
						((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT & 0x0FFF)|0xF000;
						((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT &= ~(1<<GPIO_counter);
						GPIO_counter--;
						counter=0;
				}
