...
void OpenSevenSegment(void)
{
	...
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD & 0xFFFF00FF)|0x5500;	
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT &= 0xFF0F;								
	
	
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0100)), (0x00000001 | 0x00000002 | 0x00000004 | 0x00000008 | 0x00000010 | 0x00000020 | 0x00000040 | 0x00000080), 0x3UL); 	
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0100))->DOUT &= ~(0x00000001 | 0x00000002 | 0x00000004 | 0x00000008 | 0x00000010 | 0x00000020 | 0x00000040 | 0x00000080); 						
}
...
{
	uint8_t seg7_scan[4] = {0x10, 0x20, 0x40, 0x80};		
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0100))->DOUT &= 0xFF00; 									
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0100))->DOUT |= SEG_BUF[number];							
	
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT &= 0xFF0F;										
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT |= seg7_scan[no]; 								
